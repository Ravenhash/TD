...
<!-- Vendor CSS -->
<link rel="stylesheet" href="<?php echo esc_url( get_theme_file_uri( '/assets/vendor/bootstrap/css/bootstrap.min.css' ) ); ?>">
<link rel="stylesheet" href="<?php echo esc_url( get_theme_file_uri( '/assets/vendor/fontawesome-free/css/all.min.css' ) ); ?>">
<link rel="stylesheet" href="<?php echo esc_url( get_theme_file_uri( '/assets/vendor/animate/animate.compat.css' ) ); ?>">
<link rel="stylesheet" href="<?php echo esc_url( get_theme_file_uri( '/assets/vendor/simple-line-icons/css/simple-line-icons.min.css' ) ); ?>">
<link rel="stylesheet" href="<?php echo esc_url( get_theme_file_uri( '/assets/vendor/owl.carousel/assets/owl.carousel.min.css' ) ); ?>">
<link rel="stylesheet" href="<?php echo esc_url( get_theme_file_uri( '/assets/vendor/owl.carousel/assets/owl.theme.default.min.css' ) ); ?>">
<link rel="stylesheet" href="<?php echo esc_url( get_theme_file_uri( '/assets/vendor/magnific-popup/magnific-popup.min.css' ) ); ?>">

<!-- Theme CSS -->
<link rel="stylesheet" href="<?php echo esc_url( get_theme_file_uri( '/assets/css/theme.css' ) ); ?>">
<link rel="stylesheet" href="<?php echo esc_url( get_theme_file_uri( '/assets/css/theme-elements.css' ) ); ?>">
<link rel="stylesheet" href="<?php echo esc_url( get_theme_file_uri( '/assets/css/theme-blog.css' ) ); ?>">
<link rel="stylesheet" href="<?php echo esc_url( get_theme_file_uri( '/assets/css/theme-shop.css' ) ); ?>">
